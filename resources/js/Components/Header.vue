...
<template>
    <div class="relative isolate overflow-hidden">
        <img
            :src="$page.props.path.img + '/home-hero-image.jpg'"
            alt=""
        ...
        <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            <div class="text-center">
                ...
                <div class="mt-10 flex items-center justify-center gap-x-6">
                    <Link :href="route('aboutD&D')" class="font-semibold leading-6 text-white">
                        A propos de D&D <span aria-hidden="true">→</span>
                    </Link>
                </div>
            </div>
        </div>
